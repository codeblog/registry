(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@emotion/core'), require('react'), require('tinycolor2'), require('@webthing/core')) :
  typeof define === 'function' && define.amd ? define(['@emotion/core', 'react', 'tinycolor2', '@webthing/core'], factory) :
  (global = global || self, global['@jarred/video-heading'] = factory(global['@emotion/core'], global.react, global.tinycolor2, global['@webthing/core']));
}(this, function (core, React, tinycolor, core$1) { 'use strict';
