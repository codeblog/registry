...
module.exports = {
  ...
  // webthing add italic-outline dependency-name
  //
  // For example:
  // webthing add italic-outline lodash
  dependencies: {}
};